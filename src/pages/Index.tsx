  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50">
      ...
      <div className="relative container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="mb-12 p-8 md:p-12 bg-white/70 backdrop-blur-md rounded-3xl shadow-2xl animate-scale-in border-4 border-dashed border-amber-300 print:bg-white print:border-gray-200 relative">
          ...
          <div className="mb-8 rounded-2xl overflow-hidden shadow-2xl border-4 border-amber-300">
            <img 
              src="https://cdn.poehali.dev/files/3ce55d4f-1d54-4668-8969-ff29018c89ae.jpeg" 
              alt="Наша счастливая семья на природе" 
              className="w-full h-auto sepia-[0.15] brightness-105 contrast-95"
            />
          </div>
          ...
          <div className="space-y-6 text-lg leading-relaxed">
            ...
            <p>
              Я еще маленький и не умею писать, но мама помогает мне ✍️ Хочу сказать тебе важные слова!
            </p>
            <p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
              <div className="rounded-xl overflow-hidden shadow-lg border-3 border-amber-200">
                <img 
                  src="https://cdn.poehali.dev/files/5b761712-c440-4b4b-b2d4-27ce3974bebb.jpeg" 
                  alt="Мама ждёт малыша" 
                  className="w-full h-auto object-cover sepia-[0.15] brightness-105 contrast-95"
                />
              </div>
              <div className="rounded-xl overflow-hidden shadow-lg border-3 border-amber-200">
                <img 
            ...
            <div className="my-6 rounded-xl overflow-hidden shadow-lg border-3 border-amber-200">
              <img 
            ...
            <p>
              Я еще не умею говорить "папа" 🗣️, но скоро обязательно скажу! Это будет мое первое слово, обещаю! 🤞
            </p>
            <p>
              Папочка, ты самый лучший мужчина на свете! 🌟👨 Мы с мамой всегда будем тебя поддерживать, несмотря ни на что! Ты наш герой! 🦸‍♂️💪
            </p>
            <p>
              Я не знаю, почему иногда мама плакала 😢... Но даже в самые сложные дни мы с мамочкой любили тебя и гордились тобой! ❤️ Ты всегда был и остаешься нашей опорой и защитой! 🛡️
            </p>
            <p>
              Папочка, я хочу попросить тебя о самом важном... 🙏 Давай сделаем так, чтобы мамочка всегда улыбалась и была самой счастливой на свете! 😊🌟 А когда она счастлива — весь наш дом наполняется светом и теплом! ✨🏡
            </p>
            <p>
              Я очень тобой горжусь 🏆 и хочу быть таким же заботливым, как ты. Давай вместе будем беречь нашу любимую мамочку и дарить ей радость каждый день! 💝🌸
            </p>
            <p>
